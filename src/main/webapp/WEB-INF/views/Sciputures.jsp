...
<body >
	...
	<div class="card text-center">
		...
		<ul class="nav nav-pills card-header-pills justify-content-center">
				<li class="nav-item"><a class="nav-link"  href="https://bhagavadgita.io/" target="_blank">Web Sites</a></li>
				<li class="nav-item"><a class="nav-link" href="https://www.rupanugabhajanashram.com/wp-content/uploads/2022/03/Bhagavad-gita-Swami-BG-Narasingha.pdf" target="_blank">Free Resources</a></li>
				<li class="nav-item"><a class="nav-link disabled" tabindex="-1" aria-disabled="true"><h5>Scriptures Language Translation</h5></a></li>
				<li class="nav-item"><a class="nav-link"  href="https://www.hinduamerican.org/wp-content/uploads/2019/12/Scriptures2.0_0.pdf" target="_blank">Read Scriptures</a>
				<li class="nav-item"><a class="nav-link"  href="https://www.satyavedism.org/swami-sivananda/all-about-hinduism-chapter-2-hindu-scriptures-swami-sivananda" target="_blank">Types</a></li>
			</ul>
		</div>
		<div
				...
				<div class="me-3">
					<img alt="braces"
						src="https://media.istockphoto.com/id/1172749771/vector/om-sign-and-symbol.jpg?s=612x612&w=0&k=20&c=FidmBNIIy15_q7hLetDTLQwJJIWGw4TE3kzah7d6EAA="
						height="100px" width="100px">
				</div>
				<div class="me-3">

					<h5 class="card-title">Know More About Scriptures in India</h5>
			<p class="card-text"> the Vedas, the Principal Upanishads, the Agamas and the Bhagavad Gita.</p>
			<a href="https://www.worldhistory.org/The_Vedas/" target="_blank" class="btn btn-outline-success">Try Now!</a>
				</div>
				<div class="me-3">
					<img alt=""
						src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQT0YWyIoBJsKhFARJHjR7_NYf2Znb4Cm-rg8wJ17bmPLLsATXFfj4dwU_wxHHmkKT-HSE&usqp=CAU"
						height="100px" width="100px">
				</div>
			</div>
	</div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputLanguage" name="inputLanguage" placeholder="Ancient Vedas / Sanskrit" value="${usr.inputLanguage}" >
                </div>
            </div>
