...
<body >
	...
	<div class="card text-center">
		...
		<ul class="nav nav-pills card-header-pills justify-content-center">
				<li class="nav-item"><a class="nav-link"  href="https://dayinterpreting.com/blog/characteristics-of-human-language-exploring-the-wonders-of-linguistics/" target="_blank">Web Sites</a></li>
				<li class="nav-item"><a class="nav-link" href="https://www.livelingua.com/project" target="_blank">Free Resources</a></li>
				<li class="nav-item"><a class="nav-link disabled" tabindex="-1" aria-disabled="true"><h5>Human Language Translation</h5></a></li>
				<li class="nav-item"><a class="nav-link"  href="https://summalinguae.com/language-culture/" target="_blank">Blog Posts</a>
				<li class="nav-item"><a class="nav-link"  href="https://kirkwood.pressbooks.pub/emcworthy/chapter/types-of-language/" target="_blank">Types</a></li>
			</ul>
		</div>
		<div class="card-body d-flex justify-content-center align-items-center w-100">
  <div class="me-3">
    <img alt="braces" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKherWyoWU0uYj9cAV5q6DZbCXAwkqcSjbkawvy_kQUuAZ4k4cNB1eja4I7jTS8zM2yc0&usqp=CAU" height="100px" width="100px">
  </div>
  <div class="me-3">
  ...
  <div class="me-3">
    <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAnfwMSX2H-JvdPBl3lQEl--svNi0UWdAOZqTdtKoza8F7b3GEIT61Gvms13nsWUWKWsk&usqp=CAU" height="100px" width="100px">
  </div>
</div>
	</div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputLanguage" name="inputLanguage" placeholder="English" value="${usr.inputLanguage}" >
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="outputLanguage" name="outputLanguage"placeholder="Hindi" value="${usr.outputLanguage}">
                </div>
            </div>
        </div>
